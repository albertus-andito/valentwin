...
# Changed the default lm naming convention
...
from valentwin.algorithms.starmie.augment import augment
from valentwin.algorithms.starmie.preprocessor import computeTfIdf, tfidfRowSample, preprocess
...
class PretrainTableDataset(data.Dataset):
    ...
    def __init__(self,
        ...
        self.tables = [fn for fn in os.listdir(path)]
