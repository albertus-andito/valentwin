...
for dataset in "${alite_datasets[@]}"; do
    python ../../scripts/valentwin-batch-matching.py \
      --pretrained_model_names_or_paths "albertus-andito/valentwin-$dataset-n-100-hn-10-selective-neginter-lr-3e5-bs-512" \
      --measures euc \
      --column_name_weights 0.4 \
      --column_name_measures euc \
      --holistic \
...
for dataset in "${alite_datasets[@]}"; do
    python ../../scripts/valentwin-batch-matching.py \
      --pretrained_model_names_or_paths "albertus-andito/valentwin-$dataset-n-100-hn-10-selective-noneg-lr-3e5-bs-512" \
      --measures euc \
      --column_name_weights 0.4 \
      --column_name_measures euc \
      --holistic \
...
n-100-hn-10-selective-neg-lr-3e5-bs-512-20240421-euc-cnw-04-euc
n-100-hn-10-selective-neginter-lr-3e5-bs-512-20240421-euc-cnw-04-euc
n-100-hn-10-selective-noneg-lr-3e5-bs-512-20240421-euc-cnw-04-euc