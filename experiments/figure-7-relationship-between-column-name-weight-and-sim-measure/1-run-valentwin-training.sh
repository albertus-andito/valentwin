...
torchrun --nproc-per-node=$NUM_GPU --rdzv-endpoint=localhost:$PORT_ID ../../scripts/train_valentwin.py \
    ...
    --output_dir ../result/valentwin-25ksep11-n-100-hn-10-selective-neg-lr-3e5-bs-512 \
    --num_train_epochs 3 \
    ...
    --report_to wandb \
    --run_name valentwin-25ksep11-n-100-hn-10-selective-neg-lr-3e5-bs-512 \
    --fp16 \
...
torchrun --nproc-per-node=$NUM_GPU --rdzv-endpoint=localhost:$PORT_ID ../../scripts/train_valentwin.py \
    ...
    --output_dir ../result/valentwin-500spend-n-100-hn-10-selective-neg-lr-3e5-bs-512 \
    --num_train_epochs 3 \
    --per_device_train_batch_size 64 \
    --per_device_eval_batch_size 64 \
    --learning_rate 3e-5 \
    ...
    --load_best_model_at_end \
    --report_to wandb \
    --run_name valentwin-500spend-n-100-hn-10-selective-neg-lr-3e5-bs-512 \
    --fp16 \
    --use_in_batch_instances_as_negatives \
    --restrictive_in_batch_negatives \
    "$@"
...
torchrun --nproc-per-node=$NUM_GPU --rdzv-endpoint=localhost:$PORT_ID ../../scripts/train_valentwin.py \
    ...
    --output_dir ../result/valentwin-amo-ame-n-100-hn-10-selective-neg-lr-3e5-bs-512 \
    --num_train_epochs 3 \
    --per_device_train_batch_size 64 \
    --per_device_eval_batch_size 64 \
    --learning_rate 3e-5 \
    ...
    --load_best_model_at_end \
    --report_to wandb \
    --run_name valentwin-amo-ame-n-100-hn-10-selective-neg-lr-3e5-bs-512 \
    --fp16 \
    --use_in_batch_instances_as_negatives \
    --restrictive_in_batch_negatives \
    "$@"
...
torchrun --nproc-per-node=$NUM_GPU --rdzv-endpoint=localhost:$PORT_ID ../../scripts/train_valentwin.py \
    ...
    --output_dir ../result/valentwin-chicago_parks-n-100-hn-10-selective-neg-lr-3e5-bs-512 \
    --num_train_epochs 3 \
    --per_device_train_batch_size 64 \
    --per_device_eval_batch_size 64 \
    --learning_rate 3e-5 \
    ...
    --load_best_model_at_end \
    --report_to wandb \
    --run_name valentwin-chicago_parks-n-100-hn-10-selective-neg-lr-3e5-bs-512 \
    --fp16 \
    --use_in_batch_instances_as_negatives \
    --restrictive_in_batch_negatives \
    "$@"
...
torchrun --nproc-per-node=$NUM_GPU --rdzv-endpoint=localhost:$PORT_ID ../../scripts/train_valentwin.py \
    ...
    --output_dir ../result/valentwin-cihr-n-100-hn-10-selective-neg-lr-3e5-bs-512 \
    --num_train_epochs 3 \
    --per_device_train_batch_size 64 \
    --per_device_eval_batch_size 64 \
    --learning_rate 3e-5 \
    ...
    --load_best_model_at_end \
    --report_to wandb \
    --run_name valentwin-cihr-n-100-hn-10-selective-neg-lr-3e5-bs-512 \
    --fp16 \
    --use_in_batch_instances_as_negatives \
    --restrictive_in_batch_negatives \
    "$@"
...
torchrun --nproc-per-node=$NUM_GPU --rdzv-endpoint=localhost:$PORT_ID ../../scripts/train_valentwin.py \
    ...
    --output_dir ../result/valentwin-DCMS_NHM_NHM-n-100-hn-10-selective-neg-lr-3e5-bs-512 \
    --num_train_epochs 3 \
    --per_device_train_batch_size 64 \
    --per_device_eval_batch_size 64 \
    --learning_rate 3e-5 \
    ...
    --load_best_model_at_end \
    --report_to wandb \
    --run_name valentwin-DCMS_NHM_NHM-n-100-hn-10-selective-neg-lr-3e5-bs-512 \
    --fp16 \
    --use_in_batch_instances_as_negatives \
    --restrictive_in_batch_negatives \
    "$@"
...
torchrun --nproc-per-node=$NUM_GPU --rdzv-endpoint=localhost:$PORT_ID ../../scripts/train_valentwin.py \
    ...
    --output_dir ../result/valentwin-organogram-junior-n-100-hn-10-selective-neg-lr-3e5-bs-512 \
    --num_train_epochs 3 \
    --per_device_train_batch_size 64 \
    --per_device_eval_batch_size 64 \
    --learning_rate 3e-5 \
    ...
    --load_best_model_at_end \
    --report_to wandb \
    --run_name valentwin-organogram-junior-n-100-hn-10-selective-neg-lr-3e5-bs-512 \
    --fp16 \
    --use_in_batch_instances_as_negatives \
    --restrictive_in_batch_negatives \
    "$@"
...
torchrun --nproc-per-node=$NUM_GPU --rdzv-endpoint=localhost:$PORT_ID ../../scripts/train_valentwin.py \
    ...
    --output_dir ../result/valentwin-school_report-n-100-hn-10-selective-neg-lr-3e5-bs-512 \
    --num_train_epochs 3 \
    --per_device_train_batch_size 64 \
    --per_device_eval_batch_size 64 \
    --learning_rate 3e-5 \
    ...
    --load_best_model_at_end \
    --report_to wandb \
    --run_name valentwin-school_report-n-100-hn-10-selective-neg-lr-3e5-bs-512 \
    --fp16 \
    --use_in_batch_instances_as_negatives \
    --restrictive_in_batch_negatives \
    "$@"
...
torchrun --nproc-per-node=$NUM_GPU --rdzv-endpoint=localhost:$PORT_ID ../../scripts/train_valentwin.py \
    ...
    --output_dir ../result/valentwin-academic_papers-n-100-hn-10-selective-neg-lr-3e5-bs-512 \
    --num_train_epochs 3 \
    --per_device_train_batch_size 64 \
    --per_device_eval_batch_size 64 \
    --learning_rate 3e-5 \
    ...
    --load_best_model_at_end \
    --report_to wandb \
    --run_name valentwin-academic_papers-n-100-hn-10-selective-neg-lr-3e5-bs-512 \
    --fp16 \
    --use_in_batch_instances_as_negatives \
    --restrictive_in_batch_negatives \
    "$@"
...
torchrun --nproc-per-node=$NUM_GPU --rdzv-endpoint=localhost:$PORT_ID ../../scripts/train_valentwin.py \
    ...
    --output_dir ../result/valentwin-movies-n-100-hn-10-selective-neg-lr-3e5-bs-512 \
    --num_train_epochs 3 \
    --per_device_train_batch_size 64 \
    --per_device_eval_batch_size 64 \
    --learning_rate 3e-5 \
    ...
    --load_best_model_at_end \
    --report_to wandb \
    --run_name valentwin-movies-n-100-hn-10-selective-neg-lr-3e5-bs-512 \
    --fp16 \
    --use_in_batch_instances_as_negatives \
    --restrictive_in_batch_negatives \
    "$@"
